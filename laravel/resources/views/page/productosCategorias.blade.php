...
<div class="col-12 col-md-3 pe-0 pe-md-4 d-flex flex-column flex-wrap align-items-start justify-content-start">
    <div class="sidebar w-100" style="height: fit-content;">
...
<div class="d-flex flex-row flex-wrap justify-content-start align-items-start col-12 col-md-9" style="height: fit-content;">
    {{-- PRODUCTOS DESTACADOS --}}    
      @forelse ($producto->where('activa','=',1) as $item)      
      <div id="boxProducto" class="col-12 col-md-4 d-fex flex-column justify-content-center align-items-center align-items-md-start mb-5 {{$item->obtenerColorToString()}} {{$item->obtenerPresentacionToString()}}" style="position: relative;"  data-aos="zoom-in" >
        <div class="d-flex flex-column justify-content-start align-items-center" style="width:95%;cursor:pointer;border-radius:5px;">
          ...
          <div class="d-flex flex-row flex-wrap align-items-start mt-3 w-100">
            <div class="col-6" style="height:45px;font-size:14px;font-weight:700;color:#000;margin:unset;word-break: break-word;overflow: hidden;">@if($item->obtenerCategoria() != null){{$item->obtenerCategoria()->nombre}}@endif</div>
